...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["Bit Zesty", "Gary McGhee"]
  spec.email = ["info@bitzesty.com", "gary@buzzware.com.au"]

  spec.summary = "Combines Liquid and Markdown templating for safe customer-editable pages and emails. Also supports templates from the database"
  spec.description = spec.summary
  spec.homepage = "https://github.com/bitzesty/liquid_markdown"
  spec.license = "MIT"
